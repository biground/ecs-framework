...
获取当前的播放状态。
	...
	class SubShader {
		...
		addShaderPass(vs: string, ps: string, stateMap?: {
			[key: string]: number;
		}, pipelineMode?: string): ShaderPass;
	}
...
class Sprite_Example {
	...
	class Sprite extends Node {
		 ...
		 * @override 
		 */
		on(type: any, caller: any, listener: Function, args?: any[]): EventDispatcher;
		 ...
		 * @override 
		 */
		once(type: any, caller: any, listener: Function, args?: any[]): EventDispatcher;
...
function onInit()
{
	...
	class EventDispatcher {
		 ...
		 * @return 此 EventDispatcher 对象。
		 */
		off(type: any, caller: any, listener: Function, onceOnly?: boolean): EventDispatcher;
		 ...
		 * @return 此 EventDispatcher 对象。
		 */
		offAll(type?: any): EventDispatcher;
